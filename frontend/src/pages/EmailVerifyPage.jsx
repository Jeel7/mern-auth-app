...
const EmailVerifyPage = () => {
    ...
    //=> All otp entered completely then aa func. run thase
    ...
    //=> Input box for otp ma code enter karta cursor kevi rite change thay te logic 
            ...
            text-transparent bg-clip-text'>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <motion.button
                        ...
                        font-bold py-3 px-4 rounded-lg shadow-lg hover:from-green-600 hover:to-emerald-700 
